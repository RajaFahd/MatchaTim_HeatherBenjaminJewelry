export default function TrackingPage() {
  const steps = [
    { label: 'Order Received', done: true, date: 'Jun 26, 2026' },
    { label: 'In Production', done: true, date: 'Jun 26, 2026' },
    { label: 'QC Passed', done: false, date: '—' },
  ...
  return (
    <main className="max-w-2xl mx-auto p-8">
      <a href="/packing/PO-001" className="text-sm text-gray-400 hover:text-gray-600 mb-6 inline-block">← Back to Packing</a>
